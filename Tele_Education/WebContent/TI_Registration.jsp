   ...
   if( document.Signup_form_SC.Password.value != document.Signup_form_SC.Password_check.value )
     ...
     return false;
     	...
     	if ( !((phn.val().length == 10) && (phn.val() >= 7000000000) && (phn.val() <= 9999999999)) )
		{
			...
			alert( "Mobile number should be 10 digit starting from 7,8 or 9" );
		     document.Signup_form_SC.Mobile.focus() ;
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form class="form-horizontal" action="SignupAction_TI"  name="Signup_form_SC" onsubmit="return(validate_SC());">
								<fieldset>
								...
								<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" placeholder="Enter Your Mobile Number" class="form-control" required="true" id="Mobile" name="Mobile">
										</div>
									</div>
						...
						<div class="modal-footer">
							<input type="reset" class="btn btn-default" /> <input
								type="submit" id="create_account" class="btn btn-primary" />
						</div>
					</div>
				</div>
			</form>
